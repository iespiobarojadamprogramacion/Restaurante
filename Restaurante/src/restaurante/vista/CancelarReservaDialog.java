...
import restaurante.controlador.ControladorCancelarReserva;
...
public class CancelarReservaDialog extends JDialog {
	...
	public CancelarReservaDialog(JFrame parent, SistemaGestion sistemaGestion) {
		...
		}
		{
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(e -> {
					ControladorCancelarReserva ctrl = new ControladorCancelarReserva(sistemaGestion, this);
					ctrl.confirmar();
				});
			}
			{
